...
<section class="content mx-3">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?= route_to('pegawai.ubah', $pegawai['id_pegawai']) ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kode_pegawai" id="kode_pegawai" value="<?= old('kode_pegawai', $pegawai['kode_pegawai']) ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="jabatan" id="jabatan" value="<?= old('jabatan', $pegawai['jabatan']) ?>">
                        </div>
                        <div class="form-group">
