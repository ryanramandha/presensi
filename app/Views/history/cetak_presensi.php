...
<head>
    <meta charset="UTF-8">
    <title>Cetak History Presensi</title>
...
<body>
    <h2 class="center">LAPORAN DATA PRESENSI</h2>
        ...
        <tbody>
            ...
            <?php foreach ($presensi as $row) : ?>
                <tr>
                    ...
                    <td class="center"><?= Carbon::parse($row['jam_masuk'])->format('H:i') ?></td>
                    <td class="center"><?= Carbon::parse($row['jam_pulang'])->format('H:i') ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
