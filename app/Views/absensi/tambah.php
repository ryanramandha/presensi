...
<section class="content mx-3">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?= route_to('absensi.tambah') ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_pegawai" id="id_pegawai">
                                ...
                                <?php foreach ($pegawai as $row) : ?>
                                    <option value="<?= $row['id_pegawai'] ?>" <?= old('id_pegawai') == $row['id_pegawai'] ? 'selected' : '' ?>><?= $row['kode_pegawai'] . ' - ' . $row['nama_pegawai'] ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="keterangan" id="keterangan">
                                <option value="">- Pilih -</option>
                                <option value="Off" <?= old('keterangan') == 'Off' ? 'selected' : '' ?>>Off</option>
